    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex gap-2.5">
          <div className="h-9 w-24 rounded-md bg-muted/20 animate-pulse" />
          <div className="h-9 w-24 rounded-md bg-muted/20 animate-pulse" />
          <div className="h-9 w-28 rounded-md bg-muted/20 animate-pulse" />
        </div>

        <Card>
          <CardHeader>
            <div className="space-y-2">
              <div className="h-6 w-44 rounded bg-muted/40 animate-pulse" />
              <div className="h-4 w-72 rounded bg-muted/30 animate-pulse" />
            </div>
          </CardHeader>
