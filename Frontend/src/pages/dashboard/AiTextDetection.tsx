...
export default function AiTextDetection() {
  ...
  const handleAnalyze = async () => {
    ...
    if (text.length < 50) {
      toast.warning("Text is too short for accurate analysis (min 50 chars)");
      return;
    }
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/scan/ai-text`,
        {
          method: "POST",
          headers: {
      ...
      setResult({
        ...
        details: {
          ...
          repetitivePatterns: data.repetitive_patterns,
        },
      });
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Identify whether text was written by a human or generated by AI
            models like GPT-4, Claude, or Gemini
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-20 text-center">
          <div className="flex flex-col items-center space-y-3">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Real-time detection with high precision algorithms
            </p>
          </div>
          <div className="flex flex-col items-center space-y-3">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Detects patterns from major AI models
            </p>
          </div>
          <div className="flex flex-col items-center space-y-3">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              View perplexity and burstiness scores
            </p>
          </div>
        </div>
          ...
          <Card className="flex-1 w-full shadow-xl border-slate-200 dark:border-slate-800 bg-white dark:bg-card">
            <CardHeader className="text-center border-b border-border/50 pb-8 pt-8 px-6 bg-slate-50/50 dark:bg-slate-900/20">
              ...
              <CardDescription className="text-base">
                Paste text below to check for AI generation
              </CardDescription>
            </CardHeader>
            <CardContent className="p-6 md:p-8 space-y-6">
              <div className="relative">
                <Textarea
                  ...
                  placeholder="Paste text here to analyze (articles, essays, emails)..."
                  value={text}
              ...
              >
                {isAnalyzing ? "Scanning Patterns..." : "Check for AI Content"}
              </Button>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
                    ...
                    <div className="p-3 bg-secondary/20 rounded-lg border border-border/50">
                      ...
                      <p className="text-sm font-semibold">
                        {result.details.repetitivePatterns}
                      </p>
                    </div>
                  </div>
